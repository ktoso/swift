...
distributed actor Greeter {
  // Opted into blocking IPC: the target carries isSynchronousBlockingRemoteCall == true.
  @remoteCall(blocking)
  ...
  // A plain distributed method: isSynchronousBlockingRemoteCall stays false.
  ...
  // A plain distributed computed property: isSynchronousBlockingRemoteCall stays false.
...
@main struct Main {
  static func main() async throws {
    ...
    // the target's isSynchronousBlockingRemoteCall flag is set, which the system
