...
// RUN: %target-swift-frontend -target %target-cpu-apple-macos14 -O -enable-experimental-feature Embedded -enable-experimental-feature EmbeddedDistributed -parse-as-library -wmo %s -c -o %t/a.o
