...
distributed actor MyHome: HomeAdmin {
  ...
  // CHECK-NEXT: private static let $s48distributed_macro_validation_cross_module_binary6MyHomeC8openDoor11EntitlementfMp_23__daval_openDoor_recordfMu_: Distributed._DistributedValidationRecord = (
  ...
  // CHECK: private static let $s48distributed_macro_validation_cross_module_binary6MyHomeC13openDoorAnyOf11EntitlementfMp_28__daval_openDoorAnyOf_recordfMu_: Distributed._DistributedValidationRecord = (
  ...
  // CHECK: private static let $s48distributed_macro_validation_cross_module_binary6MyHomeC18openDoorShortAnyOf11EntitlementfMp_33__daval_openDoorShortAnyOf_recordfMu_: Distributed._DistributedValidationRecord = (
  ...
  // CHECK: private static let $s48distributed_macro_validation_cross_module_binary6MyHomeC14openDoorCustom18ValidateRemoteCallfMp_29__daval_openDoorCustom_recordfMu_: Distributed._DistributedValidationRecord = (
