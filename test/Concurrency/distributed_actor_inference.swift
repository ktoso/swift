...
// BAD:
@distributed class SomeDistributedActor_1 { } // expected-error{{'@distributed' can only be applied to 'actor class' definitions, or actor-isolated async functions}}
@distributed struct SomeDistributedActor_2 { } // expected-error{{@distributed may only be used on 'class' declarations}}
@distributed enum SomeDistributedActor_3 { } // expected-error{{@distributed may only be used on 'class' declarations}}
