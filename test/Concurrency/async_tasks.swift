...
func test_unsafeContinuations() async {
  ...
  let _: String = Task.withUnsafeContinuation { cc in // expected-error{{cannot convert value of type '(_) async -> ()' to expected argument type '(Task.UnsafeContinuation<String>) -> Void'}}
