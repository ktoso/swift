...
///
/// The returned trace ID must be passed to
...
public func _traceDistributedEncodeArgumentsEnd(
  ...
  _traceEncodeArgumentsEnd(traceID, success)
}
...
public func _traceDistributedDecodeArgumentsEnd(
  ...
  guard #available(anyAppleOS 9999, *) else { return }
  guard traceID != 0 else { return }
  _traceDecodeArgumentsEnd(traceID, argumentCount, success)
}
...
public func _traceDistributedInvokeTargetEnd(
  ...
  guard #available(anyAppleOS 9999, *) else { return }
  guard traceID != 0 else { return }
  _traceInvokeTargetEnd(traceID, success)
}
