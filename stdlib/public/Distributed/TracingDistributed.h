...
///
/// A `traceId` of 0 is ignored.
void distributed_encode_arguments_end(uint64_t traceId, bool success);
...
///
/// A `traceId` of 0 is ignored.
void distributed_decode_arguments_end(uint64_t traceId, size_t argumentCount,
                                      bool success);
...
///
/// A `traceId` of 0 is ignored.
void distributed_invoke_target_end(uint64_t traceId, bool success);
