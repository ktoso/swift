...
extension SuspendingClock {
  /// Run `body` under a suspending-clock deadline.
  ///
  /// Arms a fire-once synchronous timer job on the current suspending-clock
  ...
  ///
  /// - Precondition: A ``SuspendingClockExecutor`` is available in the
